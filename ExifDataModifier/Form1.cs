    ...
    ".dng"
        ...
        private void btLocationApply_Click(object sender, EventArgs e)
        {
            ...
            foreach (String path in filePaths)
            {
                ...
                Image originalImage = Image.FromFile(path);
                Image geotaggedImage = Function.Geotag(originalImage, latitude, longitude);
                ...
                geotaggedImage.Save(newFileName, ImageFormat.Jpeg);
            ...
            DialogResult dialog = MessageBox.Show($"Geotagged image saved in _Geotagged folder, location: {gMapControl1.Position.Lat}, {gMapControl1.Position.Lng}. Clear items?", "Success", MessageBoxButtons.YesNo);
